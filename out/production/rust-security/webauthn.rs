...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct BeginAssertRequest {
    pub user_id: String,
}
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct BeginAssertResponse {
    pub public_key: serde_json::Value,
}
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FinishAssertRequest {
    pub user_id: String,
    pub credential: serde_json::Value,
}
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FinishAssertResponse {
    pub verified: bool,
}

// In-memory stubs (replace with persistent store later)
static REGISTRATION_CHALLENGES: Lazy<RwLock<HashMap<String, serde_json::Value>>> =
    Lazy::new(|| RwLock::new(HashMap::new()));
static ASSERTION_CHALLENGES: Lazy<RwLock<HashMap<String, serde_json::Value>>> =
    Lazy::new(|| RwLock::new(HashMap::new()));
static CREDENTIALS: Lazy<RwLock<HashMap<String, Vec<serde_json::Value>>>> =
    Lazy::new(|| RwLock::new(HashMap::new()));
