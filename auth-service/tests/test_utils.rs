...
impl TestFixture {
    ...
    pub async fn get_access_token_with_scope(&self, scope: Option<&str>) -> String {
        ...
        let response = self.client
            ...
            .header("Authorization", self.basic_auth_header(&self.valid_client_id, &self.valid_client_secret))
            .body(body)
            .send()
            .await
            .unwrap();
...
impl SecurityTestUtils {
        ...
        Fut: std::future::Future<Output = bool>,
    {
        ...
        let invalid_avg: f64 = invalid_times.iter().sum::<u128>() as f64 / invalid_times.len() as f64;
